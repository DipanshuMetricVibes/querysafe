    ...
    loadMarked(() => {
        ...
        const widgetHtml = `
            <div id="mv-chatbot-widget-root">
                <div id="mv-chatbot-fab" onclick="AskVibes.toggleWidget()">
                ...
                <div id="mv-chatbot-modal">
                    <div id="mv-chatbot-header">
                        ...
                        <button id="mv-chatbot-close" onclick="AskVibes.toggleWidget()" title="Close">
                    ...
                    <div id="mv-chatbot-input-bar">
                        ...
                        <button id="mv-chatbot-send-btn" onclick="AskVibes.sendMessage()" title="Send">
        ...
        window.AskVibes = {
            ...
            sendMessage: function(message) {
                ...
                .catch(error => {
                    ...
                    console.error('AskVibes Error:', error);
        ...
        if (document.readyState === 'loading') {
            document.addEventListener('DOMContentLoaded', () => AskVibes.init());
        } else {
            AskVibes.init();
        }
    });
