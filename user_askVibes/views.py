...
def send_otp_email(email, otp):
    try:
        ...
        # Create HTML content
        html_message = render_to_string('user_askVibes/email/otp_email.html', {
            'otp': otp,
...
def conversations_view(request, chatbot_id=None, conversation_id=None):
    ...
    return render(request, 'user_askVibes/conversations.html', context)
...
def chatbot_view(request, chatbot_id):
    ...
    return render(request, 'user_askVibes/chatbot-view.html', context)
...
def serve_widget_js(request, chatbot_id):
    ...
    response = render(request, 'user_askVibes/widget.js', context, content_type='application/javascript')
    response['Access-Control-Allow-Origin'] = '*'
    response['Access-Control-Allow-Methods'] = 'GET, OPTIONS'
    response['Access-Control-Allow-Headers'] = 'Content-Type'
    return response
...
def get_widget_code(chatbot_id, base_url):
    return f"""<!-- AskVibes Chatbot Widget -->
<script>
(function(w,d,s,id){{
    ...
    js.id = id;
    js.src = "{base_url}/widget/{chatbot_id}/askvibes.js";
    js.async = true;
...
def profile_view(request):
    ...
    return render(request, 'user_askVibes/profile.html', context)
...
def contact_view(request):
    if request.method == 'POST':
        ...
        try:
            ...
            html_message = render_to_string('user_askVibes/email/contact-submission.html', {
                'name': name,
                'email': email,
                'phone': phone,
                'message': message,
